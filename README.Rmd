...
[![CRAN status](https://www.r-pkg.org/badges/version/command)](https://CRAN.R-project.org/package=command)
<!-- badges: end -->

Process command line arguments as part of data analysis workflow.

The main function is [cmd_assign()](https://bayesiandemography.github.io/command/reference/cmd_assign.html).

For an overview of the \pkg{command} package, see [Quick Start](https://bayesiandemography.github.io/command/articles/a1_quickstart.html).

For ideas on building safe, modular workflows, see [Modular Workflows for Data Analysis](https://bayesiandemography.github.io/command/articles/a4_workflow.html).
